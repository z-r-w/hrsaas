  ...
  <div class="dashboard-container">
    ...
    <el-card class="header-card">
      <div>
        <div class="fl headL">
          <div class="headImg">
            <img v-imageError="defaultSrc" :src="user.userInfo.staffPhoto">
          </div>
          <div class="headInfoTip">
            <p class="firstChild">早安，{{ name }}，祝你开心每一天！</p>
            <p class="lastChild">{{ user.userInfo.username }} | {{ user.userInfo.companyName }} - {{ user.userInfo.departmentName }}</p>
          </div>
        </div>
        <div class="fr" />
      </div>
...
export default {
  ...
  data() {
    return {
      defaultSrc: require('@/assets/common/head.jpg')
    }
  },
  computed: {
    ...mapGetters([
